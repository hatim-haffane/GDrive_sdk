...
-(void)viewDidLoad
{
    ...
    self.naviBarObj = [[UINavigationBar alloc] initWithFrame:CGRectMake(0., 0., [[UIScreen mainScreen] bounds].size.width, 63.)];
    ...
    self.naviBarObj.items = [NSArray arrayWithObjects: navigItem,nil];
}
